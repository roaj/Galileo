...
# xRange = np.array([-50.6, 47.527]) # range must be updated for your device -101.264, 155.609
# yRange = np.array([-56.409, 83.509]) # range must be updated for your device

# xRange = np.array([-109.982, 75.145]) # range must be updated for your device
# yRange = np.array([-101.264, 155.609]) # range must be updated for your device

# xRange = np.array([-91.4 , 72.473]) # range must be updated for your device
# yRange = np.array([-96.964, 139.282]) # range must be updated for your device

xRange = np.array([-360 , 426.682]) # range must be updated for your device
yRange = np.array([-386.85, 383.]) # range must be updated for your device
