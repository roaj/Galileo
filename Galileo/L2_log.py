...
def uniqueFile(value, fileName): # this function takes a 2-element array called val
    txt = open("/home/debian/Galileo/" + fileName,'w+') # file with specified name
    myValue = round(value,2)
    txt.write(str(myValue))
    txt.close()
    
def uniqueFile_2(value, fileName): # this function takes a 2-element array called val
    txt = open("/home/debian/Galileo/" + fileName,'w+') # file with specified name
...
def tmpFile(myValue, fileName): # this function takes a 2-element array called val
    txt = open("/tmp/" + fileName,'w+') # file with specified name
